$(function(){
    $.ajax({
        ...
        success: function(data) {
            let trainings = _.filter(data, { part: "脚" });
            ...
            // console.log(takeVolumes.length);
            // console.log(takeDates);
            
            if(takeVolumes.length > 0){
                ...
                document.getElementById("text").innerHTML = "データがありません、トレーニングノートを投稿してください";
            }
        },
        error: function(data) {
            alert('error');
